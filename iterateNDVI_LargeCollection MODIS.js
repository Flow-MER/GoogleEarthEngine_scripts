...
// var startYear=1986;
// var endYear=2001; //inclusive
// var imageCollectionName='NOAA/CDR/AVHRR/NDVI/V5';
var startYear=2001;
var endYear=2024; //inclusive
...
var filenameBase='NDVI_ANAEv3_monthly_MODIS_';
...
// analogous to GIS zonal statistics.
    ...
    return ndvi
      ...
      .map(function(feature) {
        return feature
          ...
          .set({'yearmonth': image.get('yearmonth')});
    });
  };
  ...
  var columnsWanted=[uniqueID].concat(['yearmonth'], bandsWanted);
